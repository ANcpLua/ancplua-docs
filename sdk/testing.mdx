...
<AccordionGroup>
  ...
  <Accordion title="[AotUnsafe]">
    Marks code that intentionally uses AOT-incompatible patterns. [AL0052](/analyzers/rules/AL0052) prevents `[AotSafe]` code from calling `[AotUnsafe]` code, and [AL0053](/analyzers/rules/AL0053) flags unnecessary `[AotUnsafe]` attributes.
...
| [AL0052](/analyzers/rules/AL0052) | `[AotSafe]` must not call `[AotUnsafe]`               |
| [AL0053](/analyzers/rules/AL0053) | Unnecessary `[AotUnsafe]` attribute                   |
| [AL0094](/analyzers/rules/AL0094) | Avoid `dynamic` keyword in AOT                        |
| [AL0095](/analyzers/rules/AL0095) | Avoid `Expression.Compile()` in AOT                   |
| [AL0101](/analyzers/rules/AL0101) | Avoid `Activator.CreateInstance` in AOT               |
| [AL0102](/analyzers/rules/AL0102) | Avoid `Type.GetType` with dynamic name                |
