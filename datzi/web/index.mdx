...
slug: index
title: Web (Gateway)
summary: Overview of Datzi web and Gateway features accessible via browser.
tags: [web, gateway, overview]
---

Source: https://docs.datzi.ai/web/index
