...
For model selection rules, see [/concepts/models](/datzi/concepts/models).
...
See [Local models](/datzi/gateway/local-models) for model recommendations and custom configuration.
...
See [Local models](/datzi/gateway/local-models) for details on local proxy configuration.
...
See also: [/gateway/configuration](/datzi/gateway/configuration) for full configuration examples.
