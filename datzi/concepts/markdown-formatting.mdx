...
summary: Datzi formats outbound Markdown by converting it into a shared intermediate.
tags: ['concepts', 'markdown', 'formatting']
---

Source: https://docs.datzi.ai/concepts/markdown-formatting

# Markdown formatting

Datzi formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** — see [docs](https://docs.datzi.ai).
```
