...
summary: Provides annotated configuration examples covering common Gateway setup patterns.
tags: ['configuration', 'examples', 'yaml', 'gateway']
---

# Configuration Examples

Examples below are aligned with the current config schema. For the exhaustive reference and per-field notes,
  ...
  tools: {
    media: {
      audio: {
        ...
        maxBytes: 20971520,
        models: [
          // Local CLI fallback (Whisper binary):
          {
            type: 'cli',
            command: 'whisper',
...
If more than one person can DM your bot (multiple entries in `allowFrom`, pairing approvals for multiple people, or
...
- See [Providers](/datzi/channels/whatsapp) and [Troubleshooting](/datzi/gateway/troubleshooting) for deeper setup notes.
