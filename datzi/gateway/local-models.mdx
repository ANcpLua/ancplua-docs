...
title: Local models
summary: Explains how to configure the Gateway to route requests to locally hosted LLM models.
tags: ['local-models', 'llm', 'routing', 'gateway']
---
...
aggressively quantized or “small” checkpoints raise prompt-injection risk (see [Security](/gateway/security)).
