...
Details: [Doctor](/datzi/gateway/troubleshooting)
...
Runbook + exact service labels: [Gateway runbook](/datzi/gateway/index)
...
- Check: [Troubleshooting](/datzi/gateway/troubleshooting)
