...
Source: https://docs.datzi.ai/tools/index
...
- [Lobster](/tools/lobster): typed workflow runtime with resumable approvals (requires the Lobster CLI on the gateway
  host).
...
- Requires a Brave API key (recommended: `datzi configure --section web`, or set `BRAVE_API_KEY`).
