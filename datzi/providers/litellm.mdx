...
- **Model routing** — Switch between local Ollama models without config changes
- **Virtual keys** — Create keys with spend limits for Datzi
- **Logging** — Full request/response logs for debugging
- **Fallbacks** — Automatic failover if your primary model is down
...
```json5
{
  ...
  agents: {
    defaults: {
      model: {
        primary: 'litellm/ollama_chat/qwen3-coder:14b'
      }
    }
  }
}
