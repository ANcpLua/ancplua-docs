...
Source: https://docs.datzi.ai/automation/cron-jobs
...
see [JSON schema for tool calls](/automation/cron-jobs#json-schema-for-tool-calls).
...
- `cron.run` (force or due), `cron.runs`
  For immediate system events without a job, use [`datzi system event`](/cli/system).
