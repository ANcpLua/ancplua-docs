...
summary: Walks through the initial steps to install and run Datzi for the first time.
tags: [getting-started, install, quickstart]
---

Source: https://docs.datzi.ai/start/getting-started
...
<Info>
  ...
  <Tooltip>gateway host</Tooltip>. Docs: [Dashboard](/web/dashboard) and
