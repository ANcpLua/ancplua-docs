...
summary: Provides a high-level overview of the Datzi onboarding process.
tags: [onboarding, overview]
---

Source: https://docs.datzi.ai/start/onboarding-overview

# Onboarding Overview

Datzi supports multiple onboarding paths depending on where the Gateway runs
...
- [`datzi onboard` command](/cli/onboard)

## macOS app onboarding

Use the Datzi app when you want a fully guided setup on macOS. Docs:
