...
<CardGroup>
  <Card title="Pairing" icon="link" href="/datzi/channels/pairing">
    Discord DMs default to pairing mode.
  </Card>

<Card title="Slash commands" icon="terminal" href="/datzi/tools/slash-commands">
  Native command behavior and command catalog.
</Card>

  <Card title="Channel troubleshooting" icon="wrench" href="/datzi/channels/troubleshooting">
...
See [Slash commands](/datzi/tools/slash-commands) for command catalog and behavior.
...
- [Channel routing](/datzi/channels/channel-routing)
- [Multi-agent routing](/datzi/concepts/multi-agent)
- [Troubleshooting](/datzi/channels/troubleshooting)
- [Slash commands](/datzi/tools/slash-commands)
