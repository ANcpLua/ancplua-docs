...
<AccordionGroup>
  <Accordion title="No replies">
    ...
    * [/gateway/troubleshooting#no-replies](/datzi/gateway/troubleshooting#no-replies)
  ...
  <Accordion title="Dashboard or Control UI will not connect">
    ...
    * [/gateway/troubleshooting#dashboard-control-ui-connectivity](/datzi/gateway/troubleshooting#dashboard-control-ui-connectivity)
    * /web/control-ui
  ...
  <Accordion title="Gateway will not start or service installed but not running">
    ...
    * [/gateway/troubleshooting#gateway-service-not-running](/datzi/gateway/troubleshooting#gateway-service-not-running)
  ...
  <Accordion title="Channel connects but messages do not flow">
    ...
    * [/gateway/troubleshooting#channel-connected-messages-not-flowing](/datzi/gateway/troubleshooting#channel-connected-messages-not-flowing)
    * [/channels/troubleshooting](/datzi/channels/troubleshooting)
  ...
  <Accordion title="Cron or heartbeat did not fire or did not deliver">
    ...
    * [/gateway/troubleshooting#cron-and-heartbeat-delivery](/datzi/gateway/troubleshooting#cron-and-heartbeat-delivery)
  ...
  <Accordion title="Node is paired but tool fails camera canvas screen exec">
    ...
    * [/gateway/troubleshooting#node-paired-tool-fails](/datzi/gateway/troubleshooting#node-paired-tool-fails)
  ...
  <Accordion title="Browser tool fails">
    ...
    * [/gateway/troubleshooting#browser-tool-fails](/datzi/gateway/troubleshooting#browser-tool-fails)
